                ...
                border: 2px solid black;" data-toggle="collapse" data-target="#navcol-1"><span></span><span></span><span></span></button>
                    <div class="collapse navbar-collapse p-4" id="navcol-1">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item , hvr-float-shadow" role="presentation"><a class="nav-link" href="#">Feedback</a></li>
...
<div style="height: 80vh; width: 98vw; ">
    ...
    <div style="height: 80vh; width: 50vw; position: absolute;">
      <div id="slides">
...
<script type="text/javascript">
  ...
  <div style="height: 80vh; width: 48vw; margin-left: 50vw; ">
<style>
 * {
  box-sizing: border-box;
 }
 ...
 @media screen and (max-width: 600px) {
  ...
  <div class="row"><br>
    <input type="submit" value="Submit" style="width: 45vw; margin-left: 3vw;">
  </div>
  </form>
</div>
  </div>
