...
<input type="text" onkeyup="mysearch()" id="serchme" name="" placeholder="Search me">
<script type="text/javascript">
  function mysearch()
  {
    var txtValue;
    var a=document.getElementById('serchme').value.toUpperCase();
    var arr=document.getElementsByClassName('productname');
    ...
    border-style: inset;
                    ...
                    <div class="collapse navbar-collapse p-4" id="navcol-1">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item , hvr-float-shadow" role="presentation"><a class="nav-link" href="Categories.php">Categories</a></li>
...
<section id="data">
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (1).jpg">
      <p class="productname">Earthen Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>

  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (2).jpg">
      <p class="productname">Earthen pot</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (3).jpg">
      <p class="productname">Earthen pot</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (4).jpg">
     <p class="productname">Earthen jug</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (5).jpg">
     <p class="productname">Diya</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (6).jpg">
     <p class="productname">Hanging pots</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (7).jpg">
     <p class="productname">Printed pot</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (8).jpg">
     <p class="productname"> Colorfull tank</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
   <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (9).jpg">
     <p class="productname">Pot</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (10).jpg">
     <p class="productname">Lucky charm</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (11).jpg">
     <p class="productname">Diya</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  <div class="column">
    <div class="card">
      <img src="CST project\Earthen items\download (12).jpg">
     <p class="productname">Jug</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
