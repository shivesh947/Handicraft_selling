...
<section id="data">
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (1).jpg">
      <p class="productname">Net Lamp</p>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (2).jpg">
      <p class="productname">Twin Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (3).jpg">
      <p class="productname">Handmade Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (4).jpg">
     <p class="productname">stick Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (5).jpg">
     <p class="productname">Night Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (6).jpg">
     <p class="productname">Paper Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (7).jpg">
     <p class="productname">Crystal Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (8).jpg">
     <p class="productname">Fancy Light</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
   <div class="column">
    <div class="card">
      <img src="CST project\light items\images (9).jpg">
     <p class="productname">star light</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (10).jpg">
     <p class="productname">Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (11).jpg">
     <p class="productname">fancy Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  <div class="column">
    <div class="card">
      <img src="CST project\light items\images (12).jpg">
     <p class="productname">paper Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
