...
<section id="data">
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (1).jpg">
      <p class="productname">Hanging Love</p>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (2).jpg">
      <p class="productname">Wall decor</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (3).jpg">
      <p class="productname">Paper Craft</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (4).jpg">
     <p class="productname">gifted Card</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (5).jpg">
     <p class="productname">gifted Coco</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (6).jpg">
     <p class="productname">Dream catcher</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (7).jpg">
     <p class="productname">Dream catcher</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (8).jpg">
     <p class="productname">gifted Lamp</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
   <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (9).jpg">
     <p class="productname">gifted card</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (10).jpg">
     <p class="productname">Hanging Heart</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (11).jpg">
     <p class="productname">Wall Hanging</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
  <div class="column">
    <div class="card">
      <img src="CST project\gifted items\download (12).jpg">
     <p class="productname">gifted Frame</p>
      <input type="button" value="BUY" name="">
    </div>
  </div>
